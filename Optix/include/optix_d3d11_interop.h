...
typedef struct ID3D11Resource ID3D11Resource;
  ...
  */
  ...
  /**
  * @brief Creates a new texture sampler object from an D3D11 resource
  * 
  ...
  * @ref rtBufferCreateFromD3D11Resource.  If \a buffer was not created from an D3D11 resource \a **resource will be \a 0 after
  ...
  * @ref rtTextureSamplerGetD3D11Resource.  If \a sampler was not created from an D3D11 resource \a resource will be 0 after
  * the call and @ref RT_ERROR_INVALID_VALUE is returned
  * 
  ...
  */
  ...
  /**
  * @brief Declares an D3D11 texture as immutable and accessible by OptiX
  * 
  * @ingroup TextureSampler
  * 
  * <B>Description</B>
