...
typedef struct ID3D10Resource ID3D10Resource;
  ...
  */
  ...
  /**
  * @brief Creates a new texture sampler object from an D3D10 resource
  * 
  ...
  * @ref rtBufferCreateFromD3D10Resource.  If \a buffer was not created from an D3D10 resource \a **resource will be \a 0 after
  ...
  * @ref rtTextureSamplerGetD3D10Resource.  If \a sampler was not created from an D3D10 resource \a resource will be 0 after
  * the call and @ref RT_ERROR_INVALID_VALUE is returned
  * 
  ...
  */
  ...
  /**
  * @brief Declares an D3D10 texture as immutable and accessible by OptiX
  * 
  * @ingroup TextureSampler
  * 
  * <B>Description</B>
