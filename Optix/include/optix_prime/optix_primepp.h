...
namespace optix {
  namespace prime {
    ...
    public:
      ...
      /// The list of vertices is assumed to be a flat list of triangles and each three vertices shape a single triangle. See @ref rtpModelSetTriangles for additional information
      void setTriangles( RTPsize triCount, RTPbuffertype type, void* vertPtr, unsigned stride=0 );
      ...
      void setTriangles( RTPsize triCount, RTPbuffertype type, void* indexPtr, RTPsize vertCount, RTPbuffertype vertType, void* vertPtr, unsigned stride=0 );
    ...
    inline void ModelObj::setTriangles( RTPsize triCount, RTPbuffertype type, void* vertPtr, unsigned stride/*=0 */ )
    {
      BufferDesc vtxBufDesc( m_ctx->createBufferDesc(RTP_BUFFER_FORMAT_VERTEX_FLOAT3, type, vertPtr) );
    ...
    inline void ModelObj::setTriangles( RTPsize triCount, RTPbuffertype indexType, void* indexPtr, RTPsize vertCount, RTPbuffertype vertType, void* vertPtr, unsigned stride/*=0 */ )
    {
      BufferDesc idxBufDesc( m_ctx->createBufferDesc(RTP_BUFFER_FORMAT_INDICES_INT3, indexType, indexPtr) );
      BufferDesc vtxBufDesc( m_ctx->createBufferDesc(RTP_BUFFER_FORMAT_VERTEX_FLOAT3, vertType, vertPtr) );
