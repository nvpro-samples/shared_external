...
typedef struct IDirect3DResource9 IDirect3DResource9;
  ...
  * function must be executed once for \a context before any call to @ref rtBufferCreateFromD3D9Resource or @ref rtTextureSamplerCreateFromD3D9Resource can 
  ...
  */
  ...
  /**
  * @brief Creates a new texture sampler object from an D3D9 resource
  * 
  ...
  * @ref rtBufferCreateFromD3D9Resource.  If \a buffer was not created from an D3D9 resource \a **resource will be \a 0 after
  ...
  * @ref rtTextureSamplerGetD3D9Resource.  If \a sampler was not created from an D3D9 resource \a resource will be 0 after
  * the call and @ref RT_ERROR_INVALID_VALUE is returned
  * 
  ...
  */
  ...
  /**
  * @brief Declares an D3D9 texture as immutable and accessible by OptiX
  * 
  * @ingroup TextureSampler
  * 
  * <B>Description</B>
